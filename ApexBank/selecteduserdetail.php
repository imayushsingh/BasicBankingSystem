...
<body style="background-color : #AE275F;">
...
?>
	...
	<div class="container">
        ...
        <div class="row">
            ...
            <div class="col-6">
        <label style="color : #000000;"><b>Transfer To:</b></label>
        <select name="to" class="form-control" required>
            <option value="" disabled selected>Select Receiver's Account</option>
            <?php
                include 'config.php';
                $sid=$_GET['id'];
                $sql = "SELECT * FROM users where id!=$sid";
        ...
        <div class="col-6">
            <label style="color : #000000;"><b>Amount:</b></label>
            ...
            <button class="btn" name="submit" type="submit" id="myBtn" style="color:#0000000;">Confirm</button>
            </div>
        </form>
    </div>
